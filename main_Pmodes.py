...
FRECUENCIES = np.array([0.002, 0.0025, 0.003, 0.0035, 0.005])   # Frecuencies in Hz
...
# 
# results1 = rk4(fFunction, [0, zArray[ZLTP], k_xArray[0], 0], 0, 2, 10000)
# results2 = rk4(fFunction, [0, zArray[ZLTP], k_xArray[1], 0], 0, 2, 10000)
# results3 = rk4(fFunction, [0, zArray[ZLTP], k_xArray[2], 0], 0, 2, 10000)
# results4 = rk4(fFunction, [0, zArray[ZLTP], k_xArray[3], 0], 0, 2, 10000)
# results5 = rk4(fFunction, [0, zArray[ZLTP], k_xArray[4], 0], 0, 2, 10000)
# 
# 
...
# ax.plot(results5[0], results5[1], color=colors[4], ls=':', lw=2, label=r'$\nu$ = 5 [mHz]')
# ax.axhline(y=Z_c[4], color=colors[4], ls=':', lw=2)
...
# fig.tight_layout()
# plt.savefig(FIGDIR+'freqs_sameZ_pmodes.png',dpi=150)
# plt.show()
# 
# 
# 
...
# 
# w0 = 2*np.pi*FRECUENCIES
# equi = np.linspace(np.where(w0[1]>wc)[0][0]+20,500,4,dtype='int')
# 
# k_xArray = np.array([])  # Units will be cm^-1
# for i in 0,1,2,3:
...
# plt.ticklabel_format(axis="y", style="sci", scilimits=(0,0))
# fig.tight_layout()
# plt.savefig(FIGDIR+'freq_diffZ_pmodes.png',dpi=150)
# plt.show()
# 
# 
# 
